...
const EN = {
  ...
  'Apport investissement': 'Investment contribution',
  'Choisir…': 'Choose…',
  'Investissement supprimé': 'Deleted investment',
  "Aucun investissement dans cette devise — créez-en un d'abord": 'No investment in this currency — create one first',
  "Choisissez un investissement, ou créez-en un d'abord.": 'Choose an investment, or create one first.',
  'Fréquence': 'Frequency',
  'Mensuelle': 'Monthly',
  'Hebdomadaire': 'Weekly',
  'Annuelle': 'Yearly',
  ...
  'Part du portefeuille': 'Share of portfolio',
  'Alerte si plus de': 'Alert if over',
  '{label} représente {pct}% de votre portefeuille (seuil {threshold}%).': '{label} makes up {pct}% of your portfolio (threshold {threshold}%).',
  ...
  'Supprimer l\'investissement "{name}" et tout son historique (et les mouvements de portefeuille associés) ?': 'Delete investment "{name}" and all its history (and the associated wallet movements)?',
  'Supprimer l\'investissement "{name}" et tout son historique (mouvements de portefeuille associés ET {count} apport(s) récurrent(s) lié(s)) ?': 'Delete investment "{name}" and all its history (associated wallet movements AND {count} linked recurring contribution(s))?',
  "Débiter ce montant d'un portefeuille": 'Debit this amount from a wallet',
  'Décochez si cet investissement existait déjà avant d\'utiliser l\'app (aucun mouvement de portefeuille ne sera créé).': "Uncheck if this investment already existed before using the app (no wallet movement will be created).",
  'Choisissez un portefeuille, ou décochez "Débiter ce montant d\'un portefeuille".': 'Choose a wallet, or uncheck "Debit this amount from a wallet".',
  'Achat — {name}': 'Purchase — {name}',
  "Achat d'investissement": 'Investment purchase',
  'Apport : débité de ce portefeuille. Dividende et retrait : crédités sur ce portefeuille.': 'Contribution: debited from this wallet. Dividend and withdrawal: credited to this wallet.',
  'Retrait — {name}': 'Withdrawal — {name}',
  'Choisissez un portefeuille.': 'Choose a wallet.',
  'Dividende — {name}': 'Dividend — {name}',
  'Apport — {name}': 'Contribution — {name}',
  'Mouvement de portefeuille lié à un investissement': 'Wallet movement linked to an investment',
  'Répartir sur plusieurs portefeuilles': 'Split across multiple wallets',
  'Revenir à un seul portefeuille': 'Back to a single wallet',
  '+ Ajouter un portefeuille': '+ Add a wallet',
  'Total réparti : {sum}': 'Split total: {sum}',
  'Ajoutez au moins deux portefeuilles avec un montant.': 'Add at least two wallets with an amount.',
  'La somme des montants répartis ({sum}) doit égaler le capital investi ({total}).': 'The split amounts ({sum}) must add up to the initial capital invested ({total}).',
  'La somme des montants répartis ({sum}) doit égaler le montant ({total}).': 'The split amounts ({sum}) must add up to the amount ({total}).',
  ...
  'Valeur totale du portefeuille : {amount}': 'Total portfolio value: {amount}',
  'Apports du mois : {amount}': "This month's contributions: {amount}",
  'Dividendes du mois : {amount}': "This month's dividends: {amount}",
  'Retraits du mois : {amount}': "This month's withdrawals: {amount}",
  'Aucun investissement suivi.': 'No investment tracked.',
  ...
  'Valeur totale du portefeuille au 31 décembre : {amount}': 'Total portfolio value on Dec 31: {amount}',
  "Apports de l'année : {amount}": "This year's contributions: {amount}",
  "Dividendes de l'année : {amount}": "This year's dividends: {amount}",
  "Retraits de l'année : {amount}": "This year's withdrawals: {amount}",
  ...
  "Exporter l'historique des investissements (CSV)": 'Export investment history (CSV)',
  ...
  'Réévaluation recommandée': 'Revaluation recommended',
  '« {name} » n\'a pas été réévalué depuis plus de 3 mois — sa valeur affichée peut être obsolète.': '"{name}" hasn\'t been revalued in over 3 months — its displayed value may be outdated.',
  'Apport automatique en pause': 'Automatic contribution paused',
  '« {name} » est en pause depuis plus de 30 jours — reprenez-le si ce n\'était pas volontaire.': '"{name}" has been paused for over 30 days — resume it if that was unintentional.',
